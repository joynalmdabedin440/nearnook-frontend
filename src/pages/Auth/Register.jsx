    ...
    return (
        <div>
            ...
            <div className="w-full mx-auto max-w-md p-8 space-y-3 rounded-xl bg-gray-50 text-gray-800">
                <h1 className="text-2xl font-bold text-center text-[#2E86AB]">Sign Up</h1>
                <form noValidate="" action="" className="space-y-6">
                    <div className="space-y-1 text-sm">
                        <label htmlFor="username" className="block text-gray-600">Enter your Name</label>
                        <input type="text" name="name" id="name" placeholder="Name" className="w-full px-4 py-3 rounded-md border bg-gray-50 text-gray-800 " />
                    </div>
                    <div className="space-y-1 text-sm">
                    ...
                    <button className="block w-full p-3 text-center hover:scale-105 cursor-pointer rounded-sm text-gray-50 bg-[#2E86AB]">Sign Up</button>
                </form>
                ...
                <p className="text-xs text-center sm:px-6 text-gray-600">Already have an account?
                    <a rel="noopener noreferrer" href="#" className="underline text-[#2E86AB]">Sign In</a>
                </p>
            </div>
        </div>
    );
