    ...
    return (
        <div>
            ...
            <div className="w-full mx-auto max-w-md p-8 space-y-3 rounded-xl bg-gray-50 text-gray-800">
                <h1 className="text-2xl font-bold text-center text-[#2E86AB]">Create a vendor account</h1>
                <p className="text-xs text-center sm:px-6 text-gray-600">Already have an account?
                    <Link to="/merchantLogin" rel="noopener noreferrer" className="underline text-[#2E86AB]">Login</Link>
                </p>
